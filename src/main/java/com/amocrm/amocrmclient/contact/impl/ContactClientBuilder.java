...
public class ContactClientBuilder extends AmoCrmClientBuilder {
    ...
    public ContactClientBuilder baseUrl(String baseUrl) {
        this.baseUrl = baseUrl;
        return this;
    }

    public ContactClientBuilder login(String login) {
        this.login = login;
        return this;
    }

    public ContactClientBuilder passwordHash(String passwordHash) {
        this.passwordHash = passwordHash;
        return this;
    }

    public ContactClientBuilder httpClient(OkHttpClient httpClient) {
